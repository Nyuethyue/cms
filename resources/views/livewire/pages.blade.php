<div class="p-6">
                    ...
                    <table class="mt-5 w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="text-center bg-gray-50">
                                <th class="px-6 py-3 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Title</th>
                                <th class="px-6 py-3 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Link</th>
                                <th class="px-6 py-3 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Content</th>
                                <th class="px-6 py-3 text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Action</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @if ($data->count())
                                ...
                                @endforeach
                            @else
                                <tr class="px-6 py-4 text-sm whitespace-no-wrap" colspan="4">No Result found</tr>
                            @endif
                        </tbody>
                    </table>
                </div>
    ...
    {{-- Modal Form --}}
    <x-jet-dialog-modal wire:model.debounce.10ms="modalFormVisible">
            <x-slot name="title">
                {{ __('Save Page') }}
            </x-slot>
            ...
            <x-slot name="content">
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" wire:model="slug" class="form-input flex-1 block w-full rounded-none rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" placeholder="url-slug">
                    </div>
